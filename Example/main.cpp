...
#include <SSQLiteCpp/VariadicBind.h>
...
static const std::string filename_key_db      = getExamplePath() + "/key.db";
...
//  std::cout << "SQlite3 version " << SQLITE_VERSION << std::endl;
    ...
    try
    {
        SQLite::Database db(filename_key_db, SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
        db.key("hehehe");
